<?php
/**
 * Wolf Albums Metaboxes.
 *
 * @class WA_Admin_Metabox
 * @author WolfThemes
 * @category Admin
...
if ( ! class_exists( 'WA_Admin_Metabox' ) ) {
	/**
	 * Metabox class
	 *
	...
	class WA_Admin_Metabox {
		...
		public function render() {
			...
			echo '<table class="form-table wolf-albums-metabox-table">';

			foreach ( $this->meta as $k => $v ) {

				if ( isset( $v['help'] ) ) {
					echo '<div class="wolf-albums-metabox-help">' . $v['help'] . '</div>';
				}
			}
			...
			foreach ( $meta_fields as $field ) {
				...
				<td>";
					...
					<div>
						...
						<br><a href="#" class="button wolf-options-reset-file"><?php esc_html_e( 'Clear', 'wolf-albums' ); ?></a>
						<a href="#" class="button wolf-options-set-file"><?php esc_html_e( 'Choose a file', 'wolf-albums' ); ?></a>
					</div>
					...
					<div>
						...
						<br><a href="#" class="button wolf-options-reset-img"><?php esc_html_e( 'Clear', 'wolf-albums' ); ?></a>
						<a href="#" class="button wolf-options-set-img"><?php esc_html_e( 'Choose an image', 'wolf-albums' ); ?></a>
					</div>
					...
					-------------------------------------------*/
						...
						?>
						<p><?php esc_html_e( 'Background color', 'wolf-albums' ); ?></p>
						...
						?>
						<p><?php esc_html_e( 'Background image', 'wolf-albums' ); ?></p>
						<div>
							...
							<br><a href="#" class="button wolf-options-reset-bg"><?php esc_html_e( 'Clear', 'wolf-albums' ); ?></a>
							<a href="#" class="button wolf-options-set-bg"><?php esc_html_e( 'Choose an image', 'wolf-albums' ); ?></a>
						</div>
						<br><br>
						<?php
						}
						...
						?>
						<br>
						<p><?php esc_html_e( 'Background repeat', 'wolf-albums' ); ?></p>
						...
						?>
						<br><br>
						<p><?php esc_html_e( 'Background position', 'wolf-albums' ); ?></p>
						...
						--------------------*/
						$options = array(
							'cover' => esc_html__( 'cover (resize)', 'wolf-albums' ),
							'normal' => esc_html__( 'normal', 'wolf-albums' ),
							'resize' => esc_html__( 'responsive (hard resize)', 'wolf-albums' ),
						);

						?>
						<br><br>
						<p><?php esc_html_e( 'Background size', 'wolf-albums' ); ?></p>
						...
						if ( $parallax ) {
							?>
							<br><br>
							<p><strong><?php esc_html_e( 'Parallax', 'wolf-albums' ); ?></strong></p>
					...
					-------------------------------------------*/
						...
						if ( ! in_array( 'color', $exclude_params ) ) {
						?>
						<p><?php esc_html_e( 'Font color', 'wolf-albums' ); ?></p>
						...
						?>
							<p><?php esc_html_e( 'Font Family', 'wolf-albums' ); ?></p>
							<select name="<?php echo esc_attr( $field_id ) . '_font_name'; ?>" id="<?php echo esc_attr( $field_id ) . '_font_name'; ?>">
								<option value=''><?php esc_html_e( 'default', 'wolf-albums' ); ?></option>
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font weight', 'wolf-albums' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'For example: 400 is normal, 700 is bold.The available font weights depend on the font.<br>Leave empty to use the theme default style', 'wolf-albums' ); ?></span>
						<?php
						}

						if ( ! in_array( 'transform', $exclude_params ) ) {
							$options = array(
								'' => esc_html__( 'auto', 'wolf-albums' ),
								'none' => esc_html__( 'none', 'wolf-albums' ),
								'uppercase' => esc_html__( 'uppercase', 'wolf-albums' ),
							);
						?>
							<br><br>
							<p><?php esc_html_e( 'Font transform', 'wolf-albums' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style in the theme options', 'wolf-albums' ); ?></span>
						<?php
						}
						...
						if ( ! in_array( 'style', $exclude_params ) ) {
							$options = array(
								'' => esc_html__( 'auto', 'wolf-albums' ),
								'normal' => esc_html__( 'normal', 'wolf-albums' ),
								'italic' => esc_html__( 'italic', 'wolf-albums' ),
							);
						?>
							<br><br>
							<p><?php esc_html_e( 'Font style', 'wolf-albums' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style defined in the theme options', 'wolf-albums' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font letter spacing (omit px)', 'wolf-albums' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'Leave empty to use the style defined in the theme options', 'wolf-albums' ); ?></span>
						<?php
						}
					...
					-------------------------------------------*/
						...
						?>
						<div>
							<p><strong><?php esc_html_e( 'mp4 URL', 'wolf-albums' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'webm URL', 'wolf-albums' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'ogv URL', 'wolf-albums' ); ?></strong></p>
						...
						<div>
						<p><strong><?php esc_html_e( 'Video Image Fallback', 'wolf-albums' ); ?></strong></p>
						<input type="hidden"  name="<?php echo esc_attr( $field_id ); ?>_img" id="<?php echo esc_attr( $field_id ); ?>_img" value="<?php echo esc_attr( $img ); ?>">
