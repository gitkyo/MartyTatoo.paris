...
<article <?php post_class( 'clearfix' ); ?>   id="post-<?php the_ID(); ?>" data-post-id="<?php the_ID(); ?>">
	<div class="video">
		...
		<div class="clearfix video-inner">
			...
			<?php if ( wolf_get_theme_option( 'video_likes' ) ) : ?>
				<span class="item-icon item-like" title="<?php _e( 'Like this video', 'tattoopro' ); ?>">
			...
			<?php if ( wolf_get_theme_option( 'video_share' ) ) : ?>
				<span class="item-icon item-share" title="<?php _e( 'Share this video', 'tattoopro' ); ?> video">
					<i class="fa fa-share-alt"></i> <?php _e( 'share', 'tattoopro' ); ?>
				</span>
			<?php endif; ?>
	...
	<div class="video-meta video-inner" style="display:none;">
		...
		<ul class="video-tabs-menu">
			<li class="current"><a class="video-tab-link" href="#share-panel"><?php _e( 'Share', 'tattoopro' ); ?></a></li>
			<li><a class="video-tab-link" href="#embed-panel"><?php _e( 'Embed', 'tattoopro' ); ?></a></li>
		</ul>
		<?php endif; ?>
	...
	<div class="video-description video-inner">
		<div class="entry-meta">
			<span class="fa fa-clock-o"></span><?php printf( __( 'Uploaded %s ago', 'tattoopro' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?>
		</div>
		<?php if ( wolf_sample( wolf_no_video_content() ) ): ?>
			<div class="video-excerpt">
				<p><?php echo wolf_sample( wolf_no_video_content() ); ?></p>
				<span class="video-read-more"><?php _e( 'more', 'tattoopro' ); ?></span>
			</div>
			<div class="video-content">
				<?php echo wolf_no_video_content(); ?>
				<div class="entry-meta">
					<?php echo get_the_term_list( $post_id, 'video_type', '<span class="fa fa-folder-o"></span>', __( ', ', 'tattoopro' ), '' ); ?>
					<?php echo get_the_term_list( $post_id, 'video_tag','<br><span class="fa fa-tags"></span>', __( ', ', 'tattoopro' ), '' );; ?>
				</div>
				<span class="video-read-less"><?php _e( 'less', 'tattoopro' ); ?></span>
			</div>
		<?php else : ?>
			<div class="video-excerpt">
				<div class="entry-meta">
