...
$category = strip_tags( get_the_term_list( $post_id, 'video_type', __( 'in ', 'tattoopro'), ', ', '' ) );
...
<article id="post-<?php the_ID(); ?>" <?php post_class( array( 'video-item-container', $term_list ) ); ?>>
	<figure class="effect-lily">
		...
		<a href="<?php the_permalink(); ?>" class="mask-link entry-link"><?php _e( 'View video', 'tattoopro' ); ?></a>
