...
?>
<article <?php post_class( 'clearfix search-video-content' ); ?>   id="post-<?php the_ID(); ?>" data-post-id="<?php the_ID(); ?>">
	...
	<span class="video-summary"><?php echo wolf_sample( wolf_no_video_content(), 80 ); ?></span>
</article>