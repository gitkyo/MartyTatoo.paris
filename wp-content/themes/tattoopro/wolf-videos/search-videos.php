...
<?php if ( have_posts() && wolf_get_video_results_count() ) : ?>
	<div class="wrap">
		<p><?php printf( _n( '1 result found.', '%d results found.', wolf_get_video_results_count(), 'tattoopro' ), wolf_get_video_results_count() ); ?></p>
	</div>
<?php endif; ?>
...
<?php else : ?>
	<p class="text-center"><?php _e( 'No video found.', 'tattoopro' ); ?></p>
<?php endif; ?>
<?php
