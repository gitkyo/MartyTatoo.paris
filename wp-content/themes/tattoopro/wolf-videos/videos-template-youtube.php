	...
	<div class="video-inner inner">
		...
		$cats = get_categories( $cats_args );
			...
			if ( $loop->have_posts() ) :
				...
				echo '<section class="clearfix video-category ' . esc_attr( $cat->slug ) . '">';
				echo '<h2 class="video-tax-title"><a href="' . esc_url( get_term_link( $cat ) ) . '">' . esc_attr( $cat->name ) . '</a></h2>';
			...
			<?php endwhile; ?>
			<?php echo '</section><span class="video-category-separtor"></span>'; ?>
