...
if ( ! class_exists( 'Wolf_Framework' ) ) {
	...
	class Wolf_Framework {
		...
		private function define_constants() {
			...
			// Changelog root URL
			define( 'WOLF_UPDATE_URL', 'https://updates.' . WOLF_DOMAIN );

			// Support Forum URL :
			define( 'WOLF_SUPPORT_URL', 'https://docs.' . WOLF_DOMAIN );
		...
		public function includes() {
			...
			if ( is_file( WOLF_THEME_DIR . '/config/importer.php' ) && is_admin() ) {
				include_once( WOLF_THEME_DIR . '/config/importer.php' );
			}
		}
		...
		public function language() {
			load_theme_textdomain( 'tattoopro', WOLF_THEME_DIR . '/languages' );
