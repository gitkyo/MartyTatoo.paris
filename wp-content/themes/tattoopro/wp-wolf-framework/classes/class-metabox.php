			...
			foreach ( $meta_fields as $field ) {
				...
				<td>";
					...
					<div>
						...
						<br><a href="#" class="button wolf-options-reset-file"><?php _e( 'Clear', 'tattoopro' ); ?></a>
					...
					<div>
						...
						<br><a href="#" class="button wolf-options-reset-img"><?php _e( 'Clear', 'tattoopro' ); ?></a>
					...
					-------------------------------------------*/
						...
						?>
						<p><?php _e( 'Background color', 'tattoopro' ); ?></p>
						...
						?>
						<p><?php _e( 'Background image', 'tattoopro' ); ?></p>
						<div>
						...
						?>
						<br>
						<p><?php _e( 'Background repeat', 'tattoopro' ); ?></p>
						...
						?>
						<br><br>
						<p><?php _e( 'Background position', 'tattoopro' ); ?></p>
						...
						?>
						<br><br>
						<p><?php _e( 'Background size', 'tattoopro' ); ?></p>
						...
						if ( $parallax ) {
							?>
							<br><br>
							<p><strong><?php _e( 'Parallax', 'tattoopro' ); ?></strong></p>
					...
					-------------------------------------------*/
						...
						if ( ! in_array( 'color', $exclude_params ) ) {
						?>
						<p><?php _e( 'Font color', 'tattoopro' ); ?></p>
						...
						?>
							<br><br>
							<p><?php _e( 'Font weight', 'tattoopro' ); ?></p>
							...
							<br><span class="description"><?php _e( 'For example: 400 is normal, 700 is bold.The available font weights depend on the font.<br>Leave empty to use the theme default style', 'tattoopro' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php _e( 'Font transform', 'tattoopro' ); ?></p>
							...
							<br><span class="description"><?php _e( '"auto" is the default style in the theme options', 'tattoopro' ); ?></span>
						<?php
						}
						...
						if ( ! in_array( 'style', $exclude_params ) ) {
							$options = array(
								'' => __( 'auto', 'tattoopro' ),
								'normal' => __( 'normal', 'tattoopro' ),
								'italic' => __( 'italic', 'tattoopro' ),
							);
						?>
							<br><br>
							<p><?php _e( 'Font style', 'tattoopro' ); ?></p>
							...
							<br><span class="description"><?php _e( '"auto" is the default style defined in the theme options', 'tattoopro' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php _e( 'Font letter spacing (omit px)', 'tattoopro' ); ?></p>
							...
							<br><span class="description"><?php _e( 'Leave empty to use the style defined in the theme options', 'tattoopro' ); ?></span>
						<?php
						}
					...
					-------------------------------------------*/
						...
						?>
						<div>
							<p><strong><?php _e( 'mp4 URL', 'tattoopro' ); ?></strong></p>
						...
						<div>
							<p><strong><?php _e( 'webm URL', 'tattoopro' ); ?></strong></p>
						...
						<div>
							<p><strong><?php _e( 'ogv URL', 'tattoopro' ); ?></strong></p>
						...
						<div>
						<p><strong><?php _e( 'Video Image Fallback', 'tattoopro' ); ?></strong></p>
						<input type="hidden"  name="<?php echo esc_attr( $field_id ); ?>_img" id="<?php echo esc_attr( $field_id ); ?>_img" value="<?php echo $img; ?>">
