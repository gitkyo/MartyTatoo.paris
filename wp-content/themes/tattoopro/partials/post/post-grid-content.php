						...
						<span class="post-square-caption entry-content">
							...
							if ( in_array( $format, $format_to_show_meta ) ) :
								...
								<span class="entry-meta">
									<span class="meta"><span class="by-author"><span class="pre-meta"><?php _e( 'by', 'tattoopro' ); ?></span> <?php echo esc_attr( get_the_author() ); ?></span></span>
									<span class="meta"><span class="pre-meta"><?php _e( 'on', 'tattoopro' ); ?></span> <?php echo esc_html( get_the_date() ); ?></span>
								</span>
