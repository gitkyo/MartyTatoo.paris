		...
		if ( $is_instagram ) {
			...
			if ( $embed ) {
				if ( $has_thumbnail ) {
					...
					$media .= '<a href="' . get_permalink() . '" title="' . esc_attr( sprintf( __( 'Permalink to %s', 'tattoopro' ), the_title_attribute( 'echo=0' ) ) ) . '" rel="bookmark">';
			...
			if ( ! is_single() ) :
				$media .= '<a class="entry-link" href="' . get_permalink() . '" title="' . esc_attr( sprintf( __( 'Permalink to %s', 'tattoopro' ), the_title_attribute( 'echo=0' ) ) ) . '" rel="bookmark">';
			endif;
