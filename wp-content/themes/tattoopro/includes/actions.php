...
if ( ! function_exists( 'wolf_cart_menu_item' ) ) {
	...
	function wolf_cart_menu_item ( $items, $args ) {
		...
		if ( class_exists( 'WooCommerce' ) && function_exists( 'wc_get_page_id' ) ) {
			...
			$woo_item .= '<span class="cart-text">' . __( 'Cart', 'tattoopro' ) . '</span>';
...
$woo_item .= sprintf( _n( '%d item', '%d items', WC()->cart->cart_contents_count, 'tattoopro' ), WC()->cart->cart_contents_count );
$woo_item .= '</span></br>'; // count

			$woo_item .= '<span class="panel-total">';
			$woo_item .= __( 'Total', 'tattoopro' ) . ' ' .  WC()->cart->get_cart_total();
			$woo_item .= '</span>'; // total

			//' . __( 'Total', 'tattoopro' ) . ' ' . $total . '
						$woo_item .= '</a>';
				$woo_item .= '</span>';
			$woo_item .= '</li>';
...
if ( ! function_exists( 'wolf_search_menu_item' ) ) {
	...
	function wolf_search_menu_item( $items, $args ) {
		...
		$search_item = '<li class="search-menu-item">
			...
			<span class="search-text">' . __( 'Search', 'tattoopro' ) . '</span></a></li>';
