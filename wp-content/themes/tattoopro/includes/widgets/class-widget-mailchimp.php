...
class Wolf_Widget_Mailchimp extends WP_Widget {
	...
	public function __construct() {
		...
		$this->wolf_widget_description 	= __( 'Newsletter signup form', 'tattoopro' );
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'list' ) ); ?>"><?php _e( 'List ID', 'tattoopro' ); ?>:</label>
			...
			<br>
			<small><?php _e( 'Can be found in your mailchimp account -> Lists -> Your List Name -> Settings -> List Name & default', 'tattoopro' ); ?></small>
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'submit' ) ); ?>"><?php _e(  'Submit Text' , 'tattoopro' ); ?>:</label>
