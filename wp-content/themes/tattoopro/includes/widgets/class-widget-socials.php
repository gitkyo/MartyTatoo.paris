...
class Wolf_Widget_Theme_Socials extends WP_Widget {
	...
	public function __construct() {
		...
		$this->wolf_widget_name 		= __( 'Social Icons', 'tattoopro' );
		$this->wolf_widget_description 	= __( 'Display social icons', 'tattoopro' );
	...
	function widget( $args, $instance ) {
		...
		$services = ( isset( $instance['services'] ) ) ? $instance['services'] : null;
		echo $before_widget;
	...
	function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e(  'Title' , 'tattoopro' ); ?>:</label>
			<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>">
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'services' ) ); ?>"><?php _e( 'Services', 'tattoopro' ); ?>:</label>
			...
			<br>
			<small><?php _e( 'If you want to limit the number of social services to display, enter the services separated by a comma ( e.g: twitter,facebook )', 'tattoopro' ); ?></small>
		</p>
		<?php
	}
}