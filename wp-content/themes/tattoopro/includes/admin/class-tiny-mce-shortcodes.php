		...
		public function admin_scripts() {
			...
			wp_localize_script(
				'wolf-tinymce', 'WolfTinyMceParams', array(
					'dropcap' => __( 'Dropcap', 'tattoopro' ),
					'button' => __( 'Button', 'tattoopro' ),
					'alert' => __( 'Alert', 'tattoopro' ),
					'highlight' => __( 'Highlight', 'tattoopro' ),
					'spacer' => __( 'Vertical Height', 'tattoopro' ),
					'mailchimp' => __( 'Newsletter sign up', 'tattoopro' ),
					'fittext' => __( 'Headline', 'tattoopro' ),
					'socials' => __( 'Socials', 'tattoopro' ),
					'fonts' => __( 'Fonts', 'tattoopro' ),
					'columns' => __( 'Columns', 'tattoopro' ),
					'fontList' => $wolf_fonts,
				)
			);
		}
