...
<div class="welcome-panel-content wolf-welcome-panel-content">
	<h3><?php printf( __( 'Welcome to %s Wordpress Theme!', 'tattoopro' ), wp_get_theme()->Name ); ?></h3>

	<div class="welcome-panel-column-container">
		<div class="welcome-panel-column">
			<h4><?php _e( 'Let\'s Get Started', 'tattoopro' ); ?></h4>

				<a class="button button-primary button-hero" href="<?php echo esc_url( admin_url( 'admin.php?page=wolf-theme-options' ) ); ?>"><?php _e( 'Theme Settings', 'tattoopro' ); ?></a>
				<?php //printf( __( 'or, <a href="%s">creata a post</a>' ), esc_url( admin_url( '' ) ) ); ?>

		</div>
		<div class="welcome-panel-column">
			<h4><?php _e( 'Help', 'tattoopro' ); ?></h4>
			<ul>
				<li><i class="fa-fw fa fa-home"></i> <a target="_blank" href="http://docs.<?php echo WOLF_DOMAIN; ?>/documentation/themes/<?php echo esc_attr( wolf_get_theme_slug() ); ?>/#home"><?php _e( 'How to set up your home page', 'tattoopro' ); ?></a></li>
				<li><i class="fa-fw fa fa-bars"></i> <a target="_blank" href="http://docs.<?php echo WOLF_DOMAIN; ?>/documentation/themes/<?php echo esc_attr( wolf_get_theme_slug() ); ?>/#menus"><?php _e( 'How to set up your menus', 'tattoopro' ); ?></a></li>
				<li><i class="fa-fw fa fa-file-text-o"></i> <a target="_blank" href="http://docs.<?php echo WOLF_DOMAIN; ?>/documentation/themes/<?php echo wolf_get_theme_slug(); ?>"><?php _e( 'Documentation', 'tattoopro' ); ?></a></li>
				<li><i class="fa-fw fa fa-support"></i> <a target="_blank" href="http://help.<?php echo WOLF_DOMAIN; ?>/"><?php _e( 'Support forum', 'tattoopro' ); ?></a></li>
			</ul>
		</div>
		<div class="welcome-panel-column welcome-panel-last">
			<h4><?php _e( 'More plugins', 'tattoopro' ); ?></h4>
			<ul>
				<?php
				...
				<li><i class="fa-fw fa ti-wolf"></i> <a target="_blank" href="http://<?php echo WOLF_DOMAIN; ?>/plugins/"><?php _e( 'More plugins', 'tattoopro' ); ?></a></li>
			</ul>
		</div>
	</div>
</div>
