...
if ( ! function_exists( 'wolf_category_metabox_add' ) ) {
	...
	function wolf_category_metabox_add( $cat ) {
		...
		<div class="form-field">
			<label for="thumbnail_size"><?php _e( 'Image Size', 'tattoopro' ); ?></label>
			...
			<p class="description"><?php _e( 'Will be used for the mosaic categories shortcode only.', 'tattoopro'); ?></p>
		</div>
	<?php }
