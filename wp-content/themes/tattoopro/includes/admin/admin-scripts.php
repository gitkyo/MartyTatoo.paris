	...
	function wolf_enqueue_admin_scripts() {
		...
		wp_localize_script(
			'wolf-theme-admin', 'WolfThemeAdminParams', array(
				'addSlider' 	=> __( 'Add Slider', 'tattoopro' ),
				'insertSlider' 	=> __( 'Insert Slider', 'tattoopro' ),
				'createSlider' 	=> __( 'Create Slider', 'tattoopro' ),
				'gallery' 	=> __( 'Gallery', 'tattoopro' ),
				'insertGallery' 	=> __( 'Insert Gallery', 'tattoopro' ),
				'createGallery' => __( 'Create Gallery', 'tattoopro' ),
