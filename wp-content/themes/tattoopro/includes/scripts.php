...
if ( ! function_exists( 'wolf_enqueue_scripts' ) ) {
	...
	function wolf_enqueue_scripts() {
		...
		if ( wolf_get_theme_option( 'js_min' ) ) {
			...
			wp_enqueue_script( "$theme_slug", WOLF_THEME_URI . '/js/min/app.min.js', 'jquery', WOLF_THEME_VERSION, true );
			wp_register_script( $theme_slug . '-one-page', WOLF_THEME_URI . '/js/jquery.one-page.js', 'jquery', WOLF_THEME_VERSION, true );

		} else {
			wp_register_script( 'infinite-scroll-blog', WOLF_THEME_URI . '/js/jquery.infinitescroll-blog.js', 'jquery', $version, true );
			wp_register_script( 'gallery', WOLF_THEME_URI . '/js/jquery.gallery.js', 'jquery', $version, true );
			wp_register_script( 'item-masonry', WOLF_THEME_URI . '/js/jquery.item-masonry.js', 'jquery', $version, true );
			...
			wp_enqueue_script( 'parallax', WOLF_THEME_URI . '/js/lib/jarallax.min.js', array( 'jquery' ), '1.7.3', true );
			...
			wp_enqueue_script( 'wolf-slider', WOLF_THEME_URI . '/js/jquery.wolfSlider.js', array( 'jquery' ), $version, true );

			wp_enqueue_script( 'carousels', WOLF_THEME_URI . '/js/jquery.carousels.js', 'jquery', $version, true );
			wp_enqueue_script( 'viewsnlikes', WOLF_THEME_URI . '/js/jquery.likesnviews.js', 'jquery', $version, true );
			wp_enqueue_script( 'youtube-video-bg', WOLF_THEME_URI . '/js/youtube-video-bg.js', 'jquery', $version, true );

			wp_enqueue_script( "$theme_slug", WOLF_THEME_URI . '/js/jquery.functions.js', 'jquery', $version, true );

			wp_register_script( $theme_slug . '-one-page', WOLF_THEME_URI . '/js/jquery.one-page.js', 'jquery', $version, true );
		}
		...
		wp_localize_script(
			"$theme_slug", 'WolfThemeParams', array(
				...
				'infiniteScrollMsg' => __( 'Loading...', 'tattoopro' ),
				'infiniteScrollEndMsg' => __( 'No more post to load', 'tattoopro' ),
				'loadMoreMsg' => __( 'Load More', 'tattoopro' ),
				'infiniteScrollEmptyLoad' => wolf_get_theme_uri( '/images/empty.gif' ),
				'newsletterPlaceholder' => __( 'Your email', 'tattoopro' ),
				...
				'years' => __( 'Years', 'tattoopro' ),
				'months' => __( 'Months', 'tattoopro' ),
				'weeks' => __( 'Weeks', 'tattoopro' ),
				'days' => __( 'Days', 'tattoopro' ),
				'hours' => __( 'Hours', 'tattoopro' ),
				'minutes' => __( 'Minutes', 'tattoopro' ),
				'seconds' => __( 'Seconds', 'tattoopro' ),
				'replyTitle' => __( 'Share your thoughts', 'tattoopro' ),
