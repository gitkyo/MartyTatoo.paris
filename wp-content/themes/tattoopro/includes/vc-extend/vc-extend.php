...
if ( ! function_exists( 'single_file_settings_field' ) ) {
	...
	function single_file_settings_field( $settings, $value ) {
		...
		$output .= '<input type="text" class="wpb_vc_param_value wpb-textinput '
			...
			. $settings['param_name'] . '" id="" value="' . esc_url( $value ) . '">';
		$output .= '<br><br>';
		$output .= '<a href="#" class="button wolf-options-reset-file">' . __( 'Clear', 'tattoopro' ) . '</a>';
		$output .= '<a href="#" class="button wolf-options-set-file">' . __( 'Choose a file', 'tattoopro' ) . '</a>';
		$output .= '</div>';
		return $output;
	}
	vc_add_shortcode_param( 'single_file', 'single_file_settings_field' );
}
...
if ( ! function_exists( 'single_image_settings_field' ) ) {
	...
	function single_image_settings_field( $settings, $value ) {
		...
		$output .= '<input type="hidden" class="wpb_vc_param_value wpb-textinput '
			. $settings['param_name'] . ' '
			. $settings['type'].'_field" name="'
			. $settings['param_name'] . '" id="" value="' . absint( $value ) . '">';
		$output .= '<img ';
		...
		$output .= '<br>';
		$output .= '<a href="#" class="button wolf-options-reset-img">' . __( 'Clear', 'tattoopro' ) . '</a>';
		$output .= '<a href="#" class="button wolf-options-set-img">' . __( 'Choose an image', 'tattoopro' ) . '</a>';
		$output .= '</div>';
		return $output;
	}
	vc_add_shortcode_param( 'single_image', 'single_image_settings_field' );
}
...
if ( ! function_exists( 'searchable_settings_field' ) ) {
	...
	function searchable_settings_field( $settings, $value ) {
		...
		$output .= '<select class="wpb_vc_param_value wolf-searchable '
			. $settings['param_name'].' '
			. $settings['type'].'_field" name="'
			. $settings['param_name'] . '" id="" value="' . $value . '">';
	...
	vc_add_shortcode_param( 'searchable', 'searchable_settings_field' );
}