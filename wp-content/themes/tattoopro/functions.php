...
$wolf_theme = array(
	...
	'menus' => array(
		...
		'primary' => __( 'Main Menu', 'tattoopro' ),

		'primary-left' => __( 'Main Menu Left', 'tattoopro' ),

		'primary-right' => __( 'Main Menu Right', 'tattoopro' ),

		'secondary' => __( 'Secondary Menu', 'tattoopro' ),

		'tertiary' => __( 'Bottom Menu', 'tattoopro' ),
